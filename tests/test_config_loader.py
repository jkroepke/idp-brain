...
def _query_profile(profile_id: str) -> dict[str, Any]:
    return {
        ...
        "embedding_profile_id": "local-embedding",
        "candidate_counts": {
            "exact_top_k": 5,
            "bm25_top_k": 50,
            "vector_top_k": 50,
        ...
        "reranker_profile_id": "local-reranker",
